...
namespace gestiondatos {
	...
	private: System::Windows::Forms::ListView^ listVentas04;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listVentas04 = (gcnew System::Windows::Forms::ListView());
			...
			this->button2->Click += gcnew System::EventHandler(this, &ventas04::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &ventas04::button1_Click);
			// 
			// txttotalven
			// 
			...
			this->txtdescripcion->TabIndex = 247;
			// 
			// txtcantidadven
			// 
			...
			this->txtcantidadven->TabIndex = 246;
			// 
			// txtcodproducto04
			// 
			this->txtcodproducto04->Location = System::Drawing::Point(510, 487);
			this->txtcodproducto04->Name = L"txtcodproducto04";
			this->txtcodproducto04->Size = System::Drawing::Size(218, 20);
			this->txtcodproducto04->TabIndex = 245;
			// 
			// txtcategoria
			// 
			...
			// listVentas04
			// 
			this->listVentas04->BackColor = System::Drawing::Color::MediumSlateBlue;
			this->listVentas04->BorderStyle = System::Windows::Forms::BorderStyle::None;
			this->listVentas04->Columns->AddRange(gcnew cli::array< System::Windows::Forms::ColumnHeader^  >(8) {
				this->columnHeader1,
					this->columnHeader2, this->columnHeader3, this->columnHeader4, this->columnHeader5, this->columnHeader6, this->columnHeader7,
					this->columnHeader8
			});
			this->listVentas04->Cursor = System::Windows::Forms::Cursors::IBeam;
			this->listVentas04->Font = (gcnew System::Drawing::Font(L"Arial", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->listVentas04->ForeColor = System::Drawing::Color::White;
			this->listVentas04->HideSelection = false;
			this->listVentas04->Location = System::Drawing::Point(331, 60);
			this->listVentas04->Name = L"listVentas04";
			this->listVentas04->Size = System::Drawing::Size(890, 269);
			this->listVentas04->TabIndex = 234;
			this->listVentas04->UseCompatibleStateImageBehavior = false;
			this->listVentas04->View = System::Windows::Forms::View::Details;
			// 
			// columnHeader1
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &ventas04::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &ventas04::button3_Click_1);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &ventas04::pictureBox1_Click);
			// 
			// label13
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &ventas04::button9_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &ventas04::button8_Click);
			// 
			// pictureBox3
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &ventas04::button7_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &ventas04::button6_Click);
			// 
			// pictureBox2
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &ventas04::button5_Click);
			// 
			// label6
			// 
			...
			this->Controls->Add(this->listVentas04);
...
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	Conexion cldatos;
	cldatos.Insertarfecha04(Convert::ToInt64(txtidfecha->Text),
		txtdia->Text,
		txtmes->Text,
...
private: System::Void button8_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	String^ sentencia = "SELECT * FROM FECHA04";
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	Conexion cldatos;
	cldatos.Insertarventas04(Convert::ToInt64(txtidventa->Text),
		txtcategoria->Text,
...
private: System::Void button3_Click_1(System::Object^ sender, System::EventArgs^ e) {
	SqlConnection^ cn;
	SqlConnectionStringBuilder^ st;
	String^ id_venta; String^ categoria; String^ cod_producto04; String^ cantidadven; String^ descripcion; String^ dpi; String^ id_fecha; String^ totalven;
	st = gcnew SqlConnectionStringBuilder();
	st->DataSource = "localhost\\SQLEXPRESS";
	st->InitialCatalog = "gestiondatos";
	st->IntegratedSecurity = true;
	cn = gcnew SqlConnection(Convert::ToString(st));
	ListView^ Pro = gcnew ListView();
	String^ sentencia = "SELECT * FROM VENTAS04";
	SqlCommand^ ejecutar = gcnew SqlCommand(sentencia, cn);
	cn->Open();
	SqlDataReader^ reader = ejecutar->ExecuteReader();
	while (reader->Read())
	{
		...
		String^ srtNew3 = gcnew String(cod_producto04);
		...
		this->listVentas04->Items->Add(listView1);
	}
	cn->Close();
}
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	this->listVentas04->Items->Clear();
}
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (txtidventa->Text == "") {
		...
		SqlConnection^ cn;
		SqlConnectionStringBuilder^ st;
		String^ categoria; int cod_producto04; int cantidadven; String^ descripcion; int long long dpi; int id_fecha; int totalven;
		st = gcnew SqlConnectionStringBuilder();
		st->DataSource = "localhost\\SQLEXPRESS";
		st->InitialCatalog = "gestiondatos";
		st->IntegratedSecurity = true;
		...
		String^ sentencia = "update VENTAS04 set categoria=@categoria, cod_producto04=@cod_producto04, cantidadven=@cantidadven, descripcion=@descripcion, dpi=@dpi, id_fecha=@id_fecha, totalven=@totalven where id_venta=@id_venta";
