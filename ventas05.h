...
namespace gestiondatos {
	...
	/// Resumen de ventas05
	/// </summary>
	public ref class ventas05 : public System::Windows::Forms::Form
	{
	public:
		ventas05(void)
		{
	...
	private: System::Windows::Forms::ListView^ listVentas05;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(ventas05::typeid));
			...
			this->listVentas05 = (gcnew System::Windows::Forms::ListView());
			...
			this->button2->Click += gcnew System::EventHandler(this, &ventas05::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &ventas05::button1_Click);
			// 
			// txttotalven
			// 
			this->txttotalven->Location = System::Drawing::Point(945, 513);
			this->txttotalven->Name = L"txttotalven";
			this->txttotalven->Size = System::Drawing::Size(218, 20);
			this->txttotalven->TabIndex = 271;
			// 
			// txtfecha
			// 
			this->txtfecha->Location = System::Drawing::Point(945, 480);
			this->txtfecha->Name = L"txtfecha";
			this->txtfecha->Size = System::Drawing::Size(218, 20);
			this->txtfecha->TabIndex = 270;
			// 
			// txtdpi
			// 
			this->txtdpi->Location = System::Drawing::Point(945, 447);
			this->txtdpi->Name = L"txtdpi";
			this->txtdpi->Size = System::Drawing::Size(218, 20);
			this->txtdpi->TabIndex = 269;
			// 
			// txtdescripcion
			// 
			this->txtdescripcion->Location = System::Drawing::Point(945, 413);
			this->txtdescripcion->Name = L"txtdescripcion";
			this->txtdescripcion->Size = System::Drawing::Size(218, 20);
			this->txtdescripcion->TabIndex = 268;
			// 
			// txtcantidadven
			// 
			this->txtcantidadven->Location = System::Drawing::Point(510, 520);
			this->txtcantidadven->Name = L"txtcantidadven";
			this->txtcantidadven->Size = System::Drawing::Size(218, 20);
			this->txtcantidadven->TabIndex = 267;
			// 
			// txtcodproducto05
			// 
			this->txtcodproducto05->Location = System::Drawing::Point(510, 487);
			this->txtcodproducto05->Name = L"txtcodproducto05";
			this->txtcodproducto05->Size = System::Drawing::Size(218, 20);
			this->txtcodproducto05->TabIndex = 266;
			// 
			// txtcategoria
			// 
			...
			this->txtcategoria->TabIndex = 265;
			// 
			// label11
			// 
			...
			this->label3->Text = L"Código Producto 05:";
			// 
			// label1
			// 
			...
			// listVentas05
			// 
			this->listVentas05->BackColor = System::Drawing::Color::MediumSlateBlue;
			this->listVentas05->BorderStyle = System::Windows::Forms::BorderStyle::None;
			this->listVentas05->Columns->AddRange(gcnew cli::array< System::Windows::Forms::ColumnHeader^  >(8) {
				this->columnHeader1,
					this->columnHeader2, this->columnHeader3, this->columnHeader4, this->columnHeader5, this->columnHeader6, this->columnHeader7,
					this->columnHeader8
			});
			this->listVentas05->Cursor = System::Windows::Forms::Cursors::IBeam;
			this->listVentas05->Font = (gcnew System::Drawing::Font(L"Arial", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->listVentas05->ForeColor = System::Drawing::Color::White;
			this->listVentas05->HideSelection = false;
			this->listVentas05->Location = System::Drawing::Point(331, 60);
			this->listVentas05->Name = L"listVentas05";
			this->listVentas05->Size = System::Drawing::Size(890, 269);
			this->listVentas05->TabIndex = 255;
			this->listVentas05->UseCompatibleStateImageBehavior = false;
			this->listVentas05->View = System::Windows::Forms::View::Details;
			// 
			// columnHeader1
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &ventas05::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &ventas05::button3_Click);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &ventas05::pictureBox1_Click);
			// 
			// label13
			// 
			...
			this->label13->Size = System::Drawing::Size(344, 37);
			this->label13->TabIndex = 274;
			this->label13->Text = L"Ventas Herramientas";
			// 
			// panel1
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &ventas05::button9_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &ventas05::button8_Click);
			// 
			// pictureBox3
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &ventas05::button7_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &ventas05::button6_Click);
			// 
			// pictureBox2
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &ventas05::button5_Click);
			// 
			// label6
			// 
			...
			this->Controls->Add(this->listVentas05);
			this->Controls->Add(this->button4);
			this->Controls->Add(this->button3);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			this->Name = L"ventas05";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"ventas05";
...
#pragma endregion
	private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
		Conexion cldatos;
		cldatos.Insertarfecha05(Convert::ToInt64(txtidfecha->Text),
			txtdia->Text,
			txtmes->Text,
...
private: System::Void button8_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	String^ sentencia = "SELECT * FROM FECHA05";
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	Conexion cldatos;
	cldatos.Insertarventas05(Convert::ToInt64(txtidventa->Text),
		txtcategoria->Text,
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	SqlConnection^ cn;
	SqlConnectionStringBuilder^ st;
	String^ id_venta; String^ categoria; String^ cod_producto05; String^ cantidadven; String^ descripcion; String^ dpi; String^ id_fecha; String^ totalven;
	st = gcnew SqlConnectionStringBuilder();
	st->DataSource = "localhost\\SQLEXPRESS";
	st->InitialCatalog = "gestiondatos";
	st->IntegratedSecurity = true;
	cn = gcnew SqlConnection(Convert::ToString(st));
	ListView^ Pro = gcnew ListView();
	String^ sentencia = "SELECT * FROM VENTAS05";
	SqlCommand^ ejecutar = gcnew SqlCommand(sentencia, cn);
	cn->Open();
	SqlDataReader^ reader = ejecutar->ExecuteReader();
	while (reader->Read())
	{
		...
		String^ srtNew3 = gcnew String(cod_producto05);
		...
		this->listVentas05->Items->Add(listView1);
	}
	cn->Close();
}
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	this->listVentas05->Items->Clear();
}
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (txtidventa->Text == "") {
		...
		SqlConnection^ cn;
		SqlConnectionStringBuilder^ st;
		String^ categoria; int cod_producto05; int cantidadven; String^ descripcion; int long long dpi; int id_fecha; int totalven;
		st = gcnew SqlConnectionStringBuilder();
		st->DataSource = "localhost\\SQLEXPRESS";
		st->InitialCatalog = "gestiondatos";
		st->IntegratedSecurity = true;
		...
		String^ sentencia = "update VENTAS05 set categoria=@categoria, cod_producto05=@cod_producto05, cantidadven=@cantidadven, descripcion=@descripcion, dpi=@dpi, id_fecha=@id_fecha, totalven=@totalven where id_venta=@id_venta";
