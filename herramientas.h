...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label8->Size = System::Drawing::Size(195, 32);
			this->label8->TabIndex = 71;
			this->label8->Text = L"Herramientas";
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &herramientas::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &herramientas::button4_Click);
			// 
			// txtprecven
			// 
			...
			this->pictureBox1->Location = System::Drawing::Point(1183, 3);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(49, 50);
			this->pictureBox1->SizeMode = System::Windows::Forms::PictureBoxSizeMode::Zoom;
			this->pictureBox1->TabIndex = 73;
			this->pictureBox1->TabStop = false;
			this->pictureBox1->Click += gcnew System::EventHandler(this, &herramientas::pictureBox1_Click);
			// 
			// listAccesorios
			// 
			...
			this->listAccesorios->TabIndex = 74;
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (txtcodproducto->Text == "") {
		...
		String^ sentencia = "update HERRAMIENTAS set cantidad=@cantidad, descripcion=@descripcion, marca=@marca, modelo=@modelo, precos=@precos, precven=@precven where cod_producto05=@cod_producto05";

		SqlCommand^ ejecutar = gcnew SqlCommand(sentencia, cn);
		ejecutar->Parameters->AddWithValue("@cod_producto05", Convert::ToInt64(txtcodproducto->Text));
...
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	SqlConnection^ cn;
	SqlConnectionStringBuilder^ st;
	String^ cod_producto05; String^ cantidad; String^ descripcion; String^ marca; String^ modelo; String^ precos; String^ precven;
	st = gcnew SqlConnectionStringBuilder();
	st->DataSource = "localhost\\SQLEXPRESS";
	st->InitialCatalog = "gestiondatos";
	st->IntegratedSecurity = true;
	...
	while (reader->Read())
	{
		...
		String^ srtNew1 = gcnew String(cod_producto05);
