...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label8->Location = System::Drawing::Point(578, 27);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(105, 32);
			this->label8->TabIndex = 71;
			this->label8->Text = L"Cocina";
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &cocina::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &cocina::button4_Click);
			// 
			// txtprecven
			// 
			...
			this->pictureBox1->Location = System::Drawing::Point(1183, -1);
			...
			this->listAccesorios->TabIndex = 76;
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (txtcodproducto->Text == "") {
		...
		String^ sentencia = "update COCINA set cantidad=@cantidad, descripcion=@descripcion, marca=@marca, modelo=@modelo, precos=@precos, precven=@precven where cod_producto03=@cod_producto03";

		SqlCommand^ ejecutar = gcnew SqlCommand(sentencia, cn);
		ejecutar->Parameters->AddWithValue("@cod_producto03", Convert::ToInt64(txtcodproducto->Text));
...
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	SqlConnection^ cn;
	SqlConnectionStringBuilder^ st;
	String^ cod_producto03; String^ cantidad; String^ descripcion; String^ marca; String^ modelo; String^ precos; String^ precven;
	st = gcnew SqlConnectionStringBuilder();
	st->DataSource = "localhost\\SQLEXPRESS";
	st->InitialCatalog = "gestiondatos";
	st->IntegratedSecurity = true;
	...
	String^ sentencia = "SELECT * FROM COCINA";
	SqlCommand^ ejecutar = gcnew SqlCommand(sentencia, cn);
	cn->Open();
	...
	while (reader->Read())
	{
		...
		String^ srtNew1 = gcnew String(cod_producto03);
