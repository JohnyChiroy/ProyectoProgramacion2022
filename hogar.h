...
namespace gestiondatos {
	...
	/// Resumen de hogar
	/// </summary>
	public ref class hogar : public System::Windows::Forms::Form
	{
	public:
		hogar(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(hogar::typeid));
			...
			this->label8->Location = System::Drawing::Point(475, 21);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(96, 32);
			this->label8->TabIndex = 71;
			this->label8->Text = L"Hogar";
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &hogar::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &hogar::button4_Click);
			// 
			// txtprecven
			// 
			...
			this->pictureBox1->Location = System::Drawing::Point(1187, 3);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(49, 50);
			this->pictureBox1->SizeMode = System::Windows::Forms::PictureBoxSizeMode::Zoom;
			this->pictureBox1->TabIndex = 72;
			this->pictureBox1->TabStop = false;
			this->pictureBox1->Click += gcnew System::EventHandler(this, &hogar::pictureBox1_Click);
			// 
			// listAccesorios
			// 
			...
			this->listAccesorios->TabIndex = 73;
			...
			this->button1->Click += gcnew System::EventHandler(this, &hogar::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(60, 394);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(110, 35);
			this->button2->TabIndex = 78;
			this->button2->Text = L"Ingresar";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &hogar::button2_Click);
			// 
			// hogar
			// 
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (txtcodproducto->Text == "") {
		...
		String^ sentencia = "update HOGAR set cantidad=@cantidad, descripcion=@descripcion, marca=@marca, modelo=@modelo, precos=@precos, precven=@precven where cod_producto02=@cod_producto02";

		SqlCommand^ ejecutar = gcnew SqlCommand(sentencia, cn);
		ejecutar->Parameters->AddWithValue("@cod_producto02", Convert::ToInt64(txtcodproducto->Text));
...
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	SqlConnection^ cn;
	SqlConnectionStringBuilder^ st;
	String^ cod_producto02; String^ cantidad; String^ descripcion; String^ marca; String^ modelo; String^ precos; String^ precven;
	st = gcnew SqlConnectionStringBuilder();
	st->DataSource = "localhost\\SQLEXPRESS";
	st->InitialCatalog = "gestiondatos";
	st->IntegratedSecurity = true;
	...
	String^ sentencia = "SELECT * FROM HOGAR";
	SqlCommand^ ejecutar = gcnew SqlCommand(sentencia, cn);
	cn->Open();
	...
	while (reader->Read())
	{
		...
		String^ srtNew1 = gcnew String(cod_producto02);
